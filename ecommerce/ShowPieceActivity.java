...
public class ShowPieceActivity extends ParentActivity {

    private final String TAG = "PaintingActivity";
    private ShowPieceActivity.MyViewPagerAdapter myViewPagerAdapter;
    ...
    @Override
    void setUIData() {
        txtTopCenter.setText(getResources().getString(R.string.top_showpiece));
    }
    ...
    private void prepareData() {
        ...
        Log.d(TAG, "ShowPieceActivity: prepareData");
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getApplicationContext(), 2);
        recyclerView.setLayoutManager(layoutManager);

        Log.d(TAG, "ShowPieceActivity: " + arrayList.size());
