...
public class ModArtsActivity extends ParentActivity {

    private final String TAG = "ModArtsActivity";
    private ModArtsActivity.MyViewPagerAdapter myViewPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mod_arts);
    ...
    void setUIData() {
        ...
        txtTopCenter.setText(getResources().getString(R.string.top_madarts));
    }
    ...
    private void prepareData() {
        ...
        Log.d(TAG, "ModArtsActivity: prepareData");
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getApplicationContext(), 2);
        recyclerView.setLayoutManager(layoutManager);

        Log.d(TAG, "ModArtsActivity: " + arrayList.size());
