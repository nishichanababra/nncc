...
public class FrameActivity extends ParentActivity {
    ...
    private FrameActivity.MyViewPagerAdapter myViewPagerAdapter;
    ...
    @Override
    void setUIData() {
        txtTopCenter.setText(getResources().getString(R.string.top_frame));
    }
    ...
    private void prepareData() {
        ...
        Log.d(TAG, "FrameActivity: prepareData");
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getApplicationContext(), 2);
        recyclerView.setLayoutManager(layoutManager);

        Log.d(TAG, "FrameActivity: " + arrayList.size());
