...
public class LampShadeActivity extends ParentActivity {

    private final String TAG = "LampShadeActivity";
    private LampShadeActivity.MyViewPagerAdapter myViewPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lamp_shade);
    ...
    @Override
    void setUIData() {
        txtTopCenter.setText(getResources().getString(R.string.top_lampshade));
    }
    ...
    private void prepareData() {
        ...
        Log.d(TAG, "LampShadeActivity: prepareData");
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getApplicationContext(), 2);
        recyclerView.setLayoutManager(layoutManager);

        Log.d(TAG, "LampShadeActivity: " + arrayList.size());
