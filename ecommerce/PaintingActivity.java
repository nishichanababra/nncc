...
public class PaintingActivity extends ParentActivity {

    private final String TAG = "PaintingActivity";
    private PaintingActivity.MyViewPagerAdapter myViewPagerAdapter;
    ...
    @Override
    void setUIData() {
        txtTopCenter.setText(getResources().getString(R.string.top_painting));
    }
    ...
    private void prepareData() {
        ...
        Log.d(TAG, "PaintingActivity: prepareData");
        RecyclerView.LayoutManager layoutManager = new GridLayoutManager(getApplicationContext(), 2);
        recyclerView.setLayoutManager(layoutManager);

        Log.d(TAG, "PaintingActivity: " + arrayList.size());
